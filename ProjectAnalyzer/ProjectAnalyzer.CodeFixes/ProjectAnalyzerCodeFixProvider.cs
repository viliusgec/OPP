...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ProjectAnalyzerCodeFixProvider)), Shared]
    public class ProjectAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(ProjectAnalyzerAnalyzer.DiagnosticId);
